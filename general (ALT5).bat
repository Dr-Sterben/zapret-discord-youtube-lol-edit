...
start "zapret: general" /min "%BIN%winws.exe" --wf-tcp=80,443,8393-8400,2099,5222,5223 --wf-udp=443,50000-50100 ^
...
--filter-udp=5000-5500 --ipset="%LISTS%ipset-cloudflare.txt" --dpi-desync=syndata --new ^
